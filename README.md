...
* 筋トレを趣味としている方同士の出会いの場を作る 

# 基本的な使い方  

* アカウントを登録する
* 募集をかけてみる
* 募集が集まらなかったら、他の募集を見てみる
* 気になる募集があったら、そのユーザに直接トークしてみる
* 相手と同意の上、一緒にトレーニングする
* 一緒にトレーニングしてみて良かったら相手のアカウントをフォローする
...
あらかじめ指定しておいたメールアドレスに先程のお問い合わせが送られてきます。(ActionMailer)  
